...
a1 = Appointment.create(status: "Pending", doctor: doc1, patient: p2, date: "25/06/2019", from_time: "14:12", to_time: "14:30", condition: "Fever", note: "High temperature, some abdominal pain")
a2 = Appointment.create(status: "Pending", doctor: doc2, patient: p1, date: "20/06/2019", from_time: "15:15", to_time: "16:30", condition: "Headache", note: "Morning migraines persistently")
a3 = Appointment.create(status: "Pending", doctor: doc1, patient: p1, date: "21/05/2019", from_time: "13:12", to_time: "14:30", condition: "Cough", note: "High temperature, some abdominal pain")
